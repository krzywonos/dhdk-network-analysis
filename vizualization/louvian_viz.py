...
modularity_data = pd.read_csv("measures/measures_data/Louvian_Modularity_by_decades.csv")

def parse_communities(community_string):
    try:
        cleaned_string = re.sub(r'[{]|[}]', '', community_string)  
...
for index, row in modularity_data.iterrows():
    ...
    # assigning a community ID to each genre
    modularity_class = {}
    ...
    # connecting genres within each community
