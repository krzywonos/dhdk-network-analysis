...
os.mkdir("measures/measures_data/modularity")
...
df_greedy.to_csv("measures/measures_data/modularity/Greedy_Modularity_by_decades.csv", index_label="Decades")
df_louvian.to_csv("measures/measures_data/modularity/Louvian_Modularity_by_decades.csv", index_label="Decades")
